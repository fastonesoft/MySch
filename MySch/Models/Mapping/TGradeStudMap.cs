...
{
    public class TGradeStudMap : EntityTypeConfiguration<TGradeStud>
    {
        public TGradeStudMap()
        {
            // Primary Key
            this.HasKey(t => t.ID);
            ...
            this.Property(t => t.AddIDS).HasColumnName("AddIDS");
